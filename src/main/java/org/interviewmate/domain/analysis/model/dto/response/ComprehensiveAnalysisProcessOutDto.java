...
public class ComprehensiveAnalysisProcessOutDto {
    ...
    private List<keywordDistribution> keywordDistribution;

    public static ComprehensiveAnalysisProcessOutDto of(
            Long totalScore, List<AnalysisScoreVO> gazeScore, List<AnalysisScoreVO> poseScore, List<keywordDistribution> keywordDistribution) {
